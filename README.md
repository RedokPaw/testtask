...
Никакие библиотеки не использовались, для работы с xlsx взял Apache POI. Excel заполнял числами в 1 столбик, мои
тестовые данные находятся в src/test/resources.